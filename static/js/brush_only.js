...
//     function binarizeImageData(id) {
//         // هر پیکسلی که آلفا > 0 یا سبز > 0 باشد را 255 می‌کنیم
//         // (چون رنگ قلم سبز است؛ اگر بعداً رنگ عوض شد، شرط آلفا کافی است)
//         const d = id.data;
...
//         // متادیتا (برای رجیستر کردن بعدی)
//         const ne = sceneBounds?.getNorthEast(), sw = sceneBounds?.getSouthWest();
//         const meta = {
//             tile_id: currentTileId(),
//             uid: layerUid(selectedLayer),
//             label: layerLabel(selectedLayer),
//             code: layerCode(selectedLayer),
//             bbox: { x, y, w, h, dpr: DPR },
//             canvas_size: { w: maskCanvas.width, h: maskCanvas.height },
